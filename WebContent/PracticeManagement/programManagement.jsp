			...
			<div class="modal-content">
				...
				<div class="pmd-modal-action">
					<button data-dismiss="modal"
						class="btn pmd-ripple-effect btn-primary" type="button">确定</button>
				...
				<div class="pmd-card pmd-z-depth pmd-card-custom-view">
					...
					<div class="PM-nav">
						<a class="btn pmd-btn-raised pmd-ripple-effect btn-primary"
							href="#">查询</a> <a
							class="btn pmd-btn-raised pmd-ripple-effect btn-primary" href="#">导出</a>
						...
						<c:if test="${selectProjectsRole==9 }">
							<a class="btn pmd-btn-raised pmd-ripple-effect btn-primary"
								href="EndPracticeServlet">实训结束</a>
						</c:if>
					</div>
										...
										<tr>
											...
											<td><a
												...
												href="InfoPracticeServlet?no=${selectProject.no }"> 详情</a> <c:if
													test="${selectProject.endDate==null }">
													<c:if
														test="${selectProjectsRole==9&&selectProject.auditDate!=null }">

														<a
															href="CheckPracticeServlet?no=${selectProject.no }&type=2"
													...
													<c:if
														test="${selectProjectsRole==9&&selectProject.auditDate==null }">
														<a
															href="CheckPracticeServlet?no=${selectProject.no }&type=1"
															class="btn pmd-btn-raised pmd-ripple-effect btn-success pmd-z-depth">
															审核</a>
													</c:if>
												</c:if> <c:if
													test="${selectProjectsRole==1&&selectProject.endDate!=null }">
													<button data-target="#form-dialog-${selectProject.no }"
														data-toggle="modal"
