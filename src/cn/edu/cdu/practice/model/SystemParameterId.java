...
/**
 * SystemParameterId entity. @author MyEclipse Persistence Tools
 */

public class SystemParameterId implements java.io.Serializable {
	...
	/** minimal constructor */
	public SystemParameterId(String adminUsername, String adminPassword,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SystemParameterId))
			return false;
		SystemParameterId castOther = (SystemParameterId) other;
