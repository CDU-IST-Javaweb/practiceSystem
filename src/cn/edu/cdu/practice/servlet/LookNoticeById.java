 ...
 */
@WebServlet("/SystemsManagement/LookNoticeById")
public class LookNoticeById extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public LookNoticeById() {
        super();
    }
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//post解码方式
				...
				try {
					...
					session.setAttribute("oneNotice", noticeCompany);
					request.getRequestDispatcher("/SystemsManagement/annuncement-detail.jsp").forward(request, response);
				}catch(Exception e) {
